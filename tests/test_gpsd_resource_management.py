...
class TestGPSDResourceManagement(unittest.TestCase):
    """Test GPSD resource management (close, context manager)."""

    @patch('pygpsd.socket')
    def test_close_method(self, mock_socket_class):
    ...
    @patch('pygpsd.socket')
    def test_close_handles_exceptions(self, mock_socket_class):
