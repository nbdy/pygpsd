...
class TestData(unittest.TestCase):
    ...
    def test_from_json_3d_fix(self) -> None:
    ...
    def test_from_json_no_fix(self) -> None:
    ...
    def test_from_json_missing_tpv(self) -> None:
    ...
    def test_from_json_missing_sky(self) -> None:
    ...
    def test_from_json_invalid_tpv_type(self) -> None:
    ...
    def test_from_json_invalid_sky_type(self) -> None:
